...
class AdvertsControllerTest < ActionController::TestCase
  ...
  test "should create advert" do
    assert_difference('Advert.count') do
      post :create, advert: { description: @advert.description, name: @advert.name, position: @advert.position }
    end
  ...
  test "should update advert" do
    put :update, id: @advert, advert: { description: @advert.description, name: @advert.name, position: @advert.position }
    assert_redirected_to advert_path(assigns(:advert))
  end
