...
= *** Генерация каталога недвиджимости ***

rails generate scaffold House

apartment_type:integer
apartment_age:integer
address:string
metro_station:integer
metro_time:integer
house_type:integer
floor_house:integer
floor_apartments:integer
square_main:integer
square_live:integer
square_kitchen:integer
balcon:integer
loggia:integer
room_type:integer
windows:integer
apartment_status:integer
bathroom:integer
description:text
sell_type:integer
price:integer
...
residential_type:integer
deposit:boolean
period:integer
comission:integer
furniture_status:integer
furniture_floor:boolean
furniture_kitchen:boolean
refrigerator:boolean
tv:boolean
animal:boolean
children:boolean
washing_mashine:boolean
...
rails generate scaffold House apartment_type:integer apartment_age:integer address:string metro_station:integer metro_time:integer house_type:integer floor_house:integer floor_apartments:integer square_main:integer square_live:integer square_kitchen:integer balcon:integer loggia:integer room_type:integer windows:integer apartment_status:integer bathroom:integer description:text sell_type:integer price:integer credit:integer residential_type:integer deposit:boolean period:integer comission:integer furniture_status:integer furniture_floor:boolean furniture_kitchen:boolean refrigerator:boolean tv:boolean animal:boolean children:boolean washing_mashine:boolean fio:string phone:integer email:string
...
= *** Карта метро ***
  ...
  HOUSE_TYPE = [
    ...
    result = []
    metro.map {|elem| result << elem[:stations] }
